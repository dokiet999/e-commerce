...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('CART_DB_NAME', 'ecommerce_cart'),
...
SERVICE_HOST = os.environ.get('CART_SERVICE_HOST', 'localhost')
SERVICE_PORT = int(os.environ.get('CART_SERVICE_PORT', 8003))
